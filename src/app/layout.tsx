...
const themeScript = `try{var d=document.documentElement;var t=localStorage.getItem("microwins:theme");if(t==="dark"||(!t&&matchMedia("(prefers-color-scheme: dark)").matches))d.classList.add("dark")}catch(e){}`;
